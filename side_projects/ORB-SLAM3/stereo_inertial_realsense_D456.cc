/**
 * This file was written by Christian Brice (brice.c.aa@m.titech.ac.jp) for use
...
int main(int argc, char **argv) {
    ...
    if (argc < 3 || argc > 4) {
        cerr << endl
             << "Usage: ./stereo_inertial_realsense_D456 path_to_vocabulary path_to_settings (trajectory_file_name)"
             << endl;
        return 1;
    }
